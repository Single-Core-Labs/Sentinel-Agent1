...
/// this crate: instead of `sentinel-ai-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
impl ToolConfig {
    ...
    /// `sentinel_tool_runtime::Tool::id()`. Use this for built-in tools known
    ...
    where
        T: crate::types::tool_metadata::ToolMetadata + sentinel_tool_runtime::Tool + Default,
    {
        Self::from(&T::default())
    }
...
impl<T: crate::types::tool_metadata::ToolMetadata + sentinel_tool_runtime::Tool> From<&T>
    for ToolConfig
{
    fn from(tool: &T) -> Self {
        Self {
...
pub struct SubagentSessionResources {
    pub backend: crate::implementations::ai_build::task::backend::SubagentBackendResource,
    ...
    pub event_sender: crate::implementations::ai_build::task::types::SubagentEventSender,
    pub depth: crate::implementations::ai_build::task::types::SubagentDepthCounter,
    pub session_id: crate::implementations::ai_build::task::types::SessionIdResource,
}
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::ai_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::ai_build::web_fetch::WebFetchConfig,
    ...
    /// call the AI Imagine API. When `Disabled` (default), the tool is not
    /// registered and image generation is unavailable.
    pub image_gen_config: crate::implementations::ai_build::image_gen::ImageGenConfig,
    ...
    /// call the AI Video Generation API. When `Disabled` (default), the tool is not
    /// registered and video generation is unavailable.
    pub video_gen_config: crate::implementations::ai_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::ai_build::deploy_app::AppBuilderDeployerConfig,
    ...
    /// Auth provider which returns a sentinel_computer_hub_sdk::AuthCredential. Can be used by
    ...
    pub auth_provider: Option<sentinel_computer_hub_sdk::SharedAuthProvider>,
...
pub async fn drain_value_stream(
    mut stream: sentinel_tool_runtime::ToolStream<sentinel_tool_runtime::TypedToolOutput>,
) -> Result<serde_json::Value, sentinel_tool_runtime::ToolError> {
    use futures::StreamExt;
    while let Some(item) = stream.next().await {
        match item {
            sentinel_tool_runtime::ToolStreamItem::Progress(_) => continue,
...
fn stream_no_terminal_error() -> sentinel_tool_runtime::ToolError {
...
struct DispatchParts {
    ...
    lr_handle: Arc<dyn sentinel_computer_hub_core::ToolHandle>,
...
struct ToolEntry {
    ...
    register_in_local: Box<dyn Fn(&sentinel_computer_hub_sdk::LocalRegistry) + Send + Sync>,
}
...
pub struct FinalizedToolset {
    ...
    local_registry: sentinel_computer_hub_sdk::LocalRegistry,
    ...
    workspace_viewer_ctx: Option<sentinel_tool_runtime::WorkspaceViewerContext>,
}
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
...
pub struct ToolRegistryBuilder {
    ...
    shared_local_registry: Option<sentinel_computer_hub_sdk::LocalRegistry>,
...
impl ToolRegistryBuilder {
            ...
            + 'static,
    {
        ...
        let id = sentinel_tool_runtime::Tool::id(&tool).as_str().to_string();
        let kind = tool.kind();
        ...
        self.tools.insert(
            ...
            ToolEntry {
                ...
                register_in_local: Box::new(|lr: &sentinel_computer_hub_sdk::LocalRegistry| {
    ...
    /// Fully-qualified tool id (`"AiBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<ai_build::BashTool, ai_build::bash::BashParams>();
        b.register_with_params::<ai_build::ReadFileTool, ai_build::read_file::ReadFileParams>();
        b.register_with_params::<
                ai_build::SearchReplaceTool,
                ai_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<ai_build::ListDirTool, ai_build::list_dir::ListDirParams>();
        b.register_with_params::<ai_build::GrepTool, ai_build::grep::GrepParams>();
        b.register::<ai_build::KillTaskTool>();
        b.register::<ai_build::KillTerminalCommandTool>();
        b.register::<ai_build::TodoWriteTool>();
        b.register::<ai_build::UpdateGoalTool>();
        b.register::<ai_build::WorkflowTool>();
        b.register::<ai_build::TaskOutputTool>();
        b.register::<ai_build::GetTerminalCommandOutputTool>();
        b.register::<ai_build::WaitTasksTool>();
        b.register::<ai_build::TaskTool>();
        b.register::<ai_build::WebSearchTool>();
        b.register_with_params::<ai_build::WebFetchTool, ai_build::web_fetch::WebFetchParams>();
        b.register::<ai_build::LspTool>();
        b.register::<ai_build::ImageGenTool>();
        b.register::<ai_build::ImageEditTool>();
        b.register::<ai_build::ImageToVideoTool>();
        b.register::<ai_build::ReferenceToVideoTool>();
        b.register::<ai_build::EnterPlanModeTool>();
        b.register::<ai_build::ExitPlanModeTool>();
        b.register_with_params::<
                ai_build::AskUserQuestionTool,
                ai_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<ai_build::MonitorTool>();
        b.register::<ai_build::SchedulerCreateTool>();
        b.register::<ai_build::SchedulerDeleteTool>();
        b.register::<ai_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                ai_build_concise::ReadFileConciseTool,
                ai_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                ai_build_hashline::HashlineEditTool,
                ai_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                ai_build_hashline::HashlineGrepTool,
                ai_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            ...
            let hashline_file_ids: &[&str] = &[
                "AiBuildHashline:hashline_read",
                "AiBuildHashline:hashline_edit",
                "AiBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if image_gen_config.has_credentials() {
            match crate::implementations::ai_build::image_gen::ImageGenClient::new(
                &image_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if video_gen_config.is_enabled() {
            match crate::implementations::ai_build::video_gen::VideoGenClient::new(
                &video_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if let crate::implementations::ai_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::ai_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::AiBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::ai_build::todo::TodoState>();
        ...
        for tool_config in &config.tools {
            ...
            if let Some(desc) = &definition.function.description {
                definition.function.description = Some(truncation_config.interpolate_description(
                    ...
                    sentinel_tool_types::max_wait_block_ms(),
                ));
            }
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::ai_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::ai_build::scheduler::actor::SchedulerActor {
...
///
/// Implements the canonical `sentinel_tool_runtime::ToolDispatch` trait so the
...
#[async_trait::async_trait]
impl sentinel_tool_runtime::ToolDispatch for InnerDispatchForToolset {
    async fn call(
        &self,
        ...
        let result = self
            ...
            .and_then(|output| {
                let value = serde_json::to_value(&output).map_err(|e| {
                    sentinel_tool_runtime::ToolError::custom("output_encoding", e.to_string())
                })?;
                Ok(sentinel_tool_runtime::TypedToolOutput::from_value(
                    tool_id.clone(),
                    value,
                ))
            });
        sentinel_tool_runtime::terminal_only(result)
    }
}
impl FinalizedToolset {
    ...
    pub fn empty_for_test() -> Self {
        Self {
            ...
            local_registry: sentinel_computer_hub_sdk::LocalRegistry::new(),
    ...
    pub fn local_registry(&self) -> &sentinel_computer_hub_sdk::LocalRegistry {
        &self.local_registry
    }
    ...
    fn tool_not_found_error(tool_name: &str) -> sentinel_tool_runtime::ToolError {
        let tid = sentinel_tool_protocol::ToolId::new(tool_name)
            .unwrap_or_else(|_| sentinel_tool_protocol::ToolId::new("unknown").expect("valid"));
        sentinel_tool_runtime::ToolError::not_found(tid, format!("Tool not found: {tool_name}"))
    }
    pub async fn try_parse(
        &self,
        tool_name: &str,
        tool_params: &serde_json::Value,
    ) -> Result<ToolInput, sentinel_tool_runtime::ToolError> {
    ...
    async fn call_raw(
        ...
        parent_ctx: sentinel_tool_runtime::ToolCallContext,
    ) -> Result<crate::types::output::ToolOutput, sentinel_tool_runtime::ToolError> {
        ...
        let mut ctx = sentinel_tool_runtime::ToolCallContext::new(parent_ctx.call_id.clone());
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        if let Some(cancellation) = parent_ctx.get::<sentinel_tool_runtime::Cancellation>() {
        ...
        if let Some(cwd) = parent_ctx.extensions.get::<sentinel_tool_runtime::Cwd>() {
            ctx.extensions.insert((*cwd).clone());
        }
        let tool_id = sentinel_tool_protocol::ToolId::new(&registry_id)
            .unwrap_or_else(|_| sentinel_tool_protocol::ToolId::new("unknown").expect("valid"));
        let lr_handle = self.local_registry.find(&tool_id).ok_or_else(|| {
            sentinel_tool_runtime::ToolError::not_found(
                tool_id,
    ...
    pub async fn call_with_cancellation(
        ...
        while let Some(item) = stream.next().await {
            match item {
                sentinel_tool_runtime::ToolStreamItem::Progress(_) => continue,
                sentinel_tool_runtime::ToolStreamItem::Terminal(result) => return result,
            }
        }
        Err(stream_no_terminal_error())
    }
    ...
    ///
    /// [`ToolStream`]: sentinel_tool_runtime::ToolStream
    /// [`ToolStreamItem::Progress`]: sentinel_tool_runtime::ToolStreamItem::Progress
    pub fn call_streaming(
        ...
        tool_call_id: &str,
        cwd_override: Option<std::path::PathBuf>,
    ) -> sentinel_tool_runtime::ToolStream<ToolRunResult> {
    ...
    pub fn call_streaming_with_cancellation(
        ...
        Box::pin(async_stream::stream! {
            let parts = match this.prepare_dispatch(
                ...
                Ok(parts) => parts,
                Err(e) => {
                    yield sentinel_tool_runtime::ToolStreamItem::Terminal(Err(e));
                    return;
                }
            };
            let DispatchParts {
            ...
            while let Some(item) = inner.next().await {
                match item {
                    sentinel_tool_runtime::ToolStreamItem::Progress(p) => {
                        yield sentinel_tool_runtime::ToolStreamItem::Progress(p);
                    }
                    sentinel_tool_runtime::ToolStreamItem::Terminal(Err(e)) => {
                        yield sentinel_tool_runtime::ToolStreamItem::Terminal(Err(e));
                        return;
                    }
                    sentinel_tool_runtime::ToolStreamItem::Terminal(Ok(typed)) => {
                        let run_result = this
                            .finalize_output(typed.value, &output_converter, effective_tool_name)
                            .await;
                        yield sentinel_tool_runtime::ToolStreamItem::Terminal(run_result);
                        return;
                    }
                }
            }
            yield sentinel_tool_runtime::ToolStreamItem::Terminal(Err(stream_no_terminal_error()));
        })
    }
    ...
    fn prepare_dispatch(
        ...
        cwd_override: Option<std::path::PathBuf>,
        cancellation: Option<tokio_util::sync::CancellationToken>,
    ) -> Result<DispatchParts, sentinel_tool_runtime::ToolError> {
        let (registry_id, output_converter, reverse_params) = {
            let tools = self.tools.read();
            let entry = tools
                .iter()
        ...
        let rt_call_id = sentinel_tool_protocol::ToolCallId::new(tool_call_id)
            .unwrap_or_else(|_| sentinel_tool_protocol::ToolCallId::new_v7());
        let mut ctx = sentinel_tool_runtime::ToolCallContext::new(rt_call_id);
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        ctx.extensions.insert(
            crate::types::resources::InvokingToolParamNames::from_reverse_params(&reverse_params),
        ...
        if let Some(cwd) = cwd_override {
            ctx.extensions.insert(sentinel_tool_runtime::Cwd(cwd));
        }
        if let Some(cancellation) = cancellation {
            ctx.extensions
                .insert(sentinel_tool_runtime::Cancellation(cancellation));
        }
        if let Some(ref version) = contract_version {
            ctx.extensions
                .insert(sentinel_tool_runtime::BehaviorVersion(version.clone()));
        }
    ...
    ///
    /// The tool must implement `sentinel_tool_runtime::Tool + ToolMetadata`.
    ...
    where
        T: sentinel_tool_runtime::Tool + ToolMetadata + std::fmt::Debug + Send + Sync + 'static,
        T::Output: serde::Serialize,
    {
        ...
        let kind = tool.kind();
        let registry_id = sentinel_tool_runtime::Tool::id(&tool).as_str().to_owned();
    ...
    pub fn unregister_tools_by_prefix(&self, prefix: &str) -> usize {
        ...
        let to_remove: Vec<_> = tools
            ...
            .filter_map(|t| sentinel_tool_protocol::ToolId::new(&t.registry_id).ok())
            .collect();
    ...
    pub fn unregister_tool_by_name(&self, name: &str) -> bool {
        ...
        let tool_id = tools
            ...
            .and_then(|t| sentinel_tool_protocol::ToolId::new(&t.registry_id).ok());
        let before = tools.len();
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "AiBuild:get_task_output" => {
            let has_ai_build_bash = has_tool_with_bool_param(
                proposed,
                "AiBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_ai_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "AiBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "AiBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "AiBuild", "run_terminal_cmd")
                && !has_ai_build_bash
            {
                notes
                    .push(
                        "AiBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "AiBuildConcise", "run_terminal_cmd")
                && !has_ai_build_concise_bash
            {
                notes
                    .push(
                        "AiBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (AiBuild:run_terminal_cmd or AiBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or AiBuild:task"
                .to_string();
            let has_provider = has_ai_build_bash || has_ai_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or AiBuild:task",
                )
                .with_category("requirements")
        }
        "AiBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as AiBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "AiBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires AiBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include AiBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "AiBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires AiBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include AiBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    /// appeared before `ai_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AiBuild:search_replace".to_string(),
                    params: Some(
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AiBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full AiBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::ai_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("AiBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (ai).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let ai = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("AiBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("AiBuild:get_task_output".to_string()),
                        ToolConfig::from_id("AiBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("ai toolset should finalize");
        assert_eq!(
            ai.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn capabilities_is_read_only_matches_metadata() {
        ...
        let mismatches: Vec<String> = builder
            ...
            .filter_map(|(name, entry)| {
                let lr = sentinel_computer_hub_sdk::LocalRegistry::new();
                (entry.register_in_local)(&lr);
                let id = sentinel_tool_protocol::ToolId::new(&entry.id)
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({"id": "AiBuild:read_file", "kind": "read"}));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({"id": "AiBuild:read_file", "kind": "raed"}));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({"id": "AiBuild:read_file"}));
    ...
    /// Verify AiBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AiBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "AiBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "AiBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<ai_build::GrepTool>(),
                ToolConfig::for_tool::<ai_build::KillTaskTool>(),
                ToolConfig::for_tool::<ai_build::TaskOutputTool>(),
                ToolConfig {
                    id: "AiBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        ...
        for id in [
            ...
            "AiBuild:list_dir",
            "AiBuild:grep",
            "AiBuild:get_terminal_command_output",
            "AiBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("AiBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("AiBuild:run_terminal_cmd", ToolKind::Execute),
            ("AiBuild:read_file", ToolKind::Read),
            ("AiBuild:search_replace", ToolKind::Edit),
            ("AiBuild:grep", ToolKind::Search),
            ("AiBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("AiBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `AiBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AiBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "AiBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AiBuildHashline:hashline_read".to_string(),
                params: Some(
                    serde_json::from_value(serde_json::json!({
                        "hash_len": 0
                    }))
    ...
    impl sentinel_tool_runtime::Tool for FakeMcpTool {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> sentinel_tool_protocol::ToolId {
            sentinel_tool_protocol::ToolId::new("fake_mcp").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::sentinel_tool_runtime::ListToolsContext,
        ) -> sentinel_tool_types::ToolDescription {
            sentinel_tool_types::ToolDescription::new("fake_mcp", &self.description)
        }
        async fn run(
            &self,
            _ctx: sentinel_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> Result<String, sentinel_tool_runtime::ToolError> {
            Ok("ok".into())
        }
    }
    #[tokio::test]
    ...
    impl sentinel_tool_runtime::Tool for NonStreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> sentinel_tool_protocol::ToolId {
            sentinel_tool_protocol::ToolId::new("non_streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::sentinel_tool_runtime::ListToolsContext,
        ) -> sentinel_tool_types::ToolDescription {
            sentinel_tool_types::ToolDescription::new("non_streaming_stub", "non-streaming stub")
        }
        async fn run(
            &self,
            _ctx: sentinel_tool_runtime::ToolCallContext,
    ...
    impl sentinel_tool_runtime::Tool for StreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> sentinel_tool_protocol::ToolId {
            sentinel_tool_protocol::ToolId::new("streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::sentinel_tool_runtime::ListToolsContext,
        ) -> sentinel_tool_types::ToolDescription {
            sentinel_tool_types::ToolDescription::new("streaming_stub", "streaming stub")
        }
        async fn run(
            &self,
            _ctx: sentinel_tool_runtime::ToolCallContext,
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<ai_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    impl sentinel_tool_runtime::Tool for NoTerminalStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> sentinel_tool_protocol::ToolId {
            sentinel_tool_protocol::ToolId::new("no_terminal_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::sentinel_tool_runtime::ListToolsContext,
        ) -> sentinel_tool_types::ToolDescription {
            sentinel_tool_types::ToolDescription::new("no_terminal_stub", "no-terminal stub")
        }
        async fn run(
            &self,
            _ctx: sentinel_tool_runtime::ToolCallContext,
    ...
    async fn non_pi_finalized_contract_snapshot_is_unchanged() {
        ...
        let toolset = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::for_tool::<ai_build::TodoWriteTool>(),
...
"##,
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ai_build::ReadFileTool>(),
                ToolConfig::for_tool::<ai_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "AiBuild:task"
                && e.message.contains("AiBuild:get_task_output")
                && e.message.contains("AiBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AiBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "AiBuild:task" && e.message.contains("AiBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AiBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// ai-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("AiBuild:run_terminal_cmd"),
                tool("AiBuild:task"),
                tool("AiBuild:get_task_output"),
                tool("AiBuild:wait_tasks"),
                tool("AiBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("AiBuild:get_task_output"));
        assert!(error.message.contains("AiBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "AiBuild:task");
        assert!(error.message.contains("AiBuild:get_task_output"));
        assert!(error.message.contains("AiBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "AiBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AiBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AiBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default ai-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("AiBuildHashline:hashline_read"),
                hashline_tool_config("AiBuildHashline:hashline_edit"),
                hashline_tool_config("AiBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("AiBuild:read_file"),
                hashline_tool_config("AiBuild:search_replace"),
                hashline_tool_config("AiBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ai_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<ai_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AiBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<ai_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<ai_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<ai_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "AiBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background": true })
                    .as_object()
                    .unwrap()
    ...
    async fn ai_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ai_build::ListDirTool>(),
                ToolConfig::for_tool::<ai_build::ReadFileTool>(),
                ToolConfig::for_tool::<ai_build::SearchReplaceTool>(),
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = ai_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = ai_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<ai_build::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    fn generate_schema_strips_root_title_and_description() {
        let schema = generate_schema::<crate::implementations::ai_build::bash::BashToolInput>();
        assert!(
    ...
    async fn prepare_dispatch_stamps_workspace_viewer_ctx_when_present() {
        let (toolset, _tmp) =
            toolset_with_viewer_ctx(Some(sentinel_tool_runtime::WorkspaceViewerContext {
        ...
        let wvc = parts
            .ctx
            .extensions
            .get::<sentinel_tool_runtime::WorkspaceViewerContext>()
    ...
    async fn bash_streaming_progress_emitted_via_finalized_toolset_when_gate_on() {
        ...
        while let Some(item) = stream.next().await {
            match item {
                sentinel_tool_runtime::ToolStreamItem::Progress(_) => progress_count += 1,
                sentinel_tool_runtime::ToolStreamItem::Terminal(r) => {
