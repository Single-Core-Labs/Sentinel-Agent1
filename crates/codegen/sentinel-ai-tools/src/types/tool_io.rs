...
use crate::implementations::ai_build::grep::GrepSearchInput;
use crate::implementations::ai_build::image_edit::ImageEditInput;
use crate::implementations::ai_build::image_gen::ImageGenInput;
use crate::implementations::ai_build::list_dir::ListDirInput;
use crate::implementations::ai_build::read_file::ReadFileInput;
use crate::implementations::ai_build::search_replace::SearchReplaceInput;
use crate::implementations::ai_build::todo::TodoWriteInput;
use crate::implementations::ai_build::update_goal::UpdateGoalInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::ai_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::ai_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::ai_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::ai_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::ai_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::ai_build::workflow::WorkflowToolInput),
