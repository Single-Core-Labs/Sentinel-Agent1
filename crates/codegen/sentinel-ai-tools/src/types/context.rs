...
/// ai-tools.proto) is deprecated and ignored.
...
impl TruncationConfig {
    ...
    ///   ai_build `read_file` never clips lines.
    ///
    ...
    pub fn interpolate_description(
        ...
        description
            ...
            .replace(
                "{max_wait_ms}",
                &sentinel_tool_types::format_wait_cap_ms(max_wait_ms),
            )
...
mod tests {
    ...
    fn interpolate_description_resolves_max_wait_ms() {
        ...
        let default_cap =
            sentinel_tool_types::format_wait_cap_ms(sentinel_tool_types::MAX_WAIT_BLOCK_MS_DEFAULT);
        assert_eq!(
            TruncationConfig::default().interpolate_description(
                "capped at {max_wait_ms}",
                "get_task_output",
                40_000,
                sentinel_tool_types::MAX_WAIT_BLOCK_MS_DEFAULT,
            ),
