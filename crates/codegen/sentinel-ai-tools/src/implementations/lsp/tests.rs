...
/// `cargo test -p sentinel-ai-shell e2e_real_typescript_language_server -- --ignored`
#[ignore]
#[tokio::test(flavor = "current_thread")]
...
/// (which changes only when ai restarts it), the number of server processes,
...
///   cargo test -p sentinel-ai-tools e2e_real_roslyn_survives_editing -- --ignored --nocapture
/// ```
#[ignore]
#[tokio::test(flavor = "multi_thread")]
