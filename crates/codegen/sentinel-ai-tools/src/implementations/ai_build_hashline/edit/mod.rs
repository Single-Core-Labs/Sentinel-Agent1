...
impl sentinel_tool_runtime::Tool for HashlineEditTool {
    type Args = HashlineEditInput;
    type Output = crate::types::output::SearchReplaceOutput;

    fn id(&self) -> sentinel_tool_protocol::ToolId {
        sentinel_tool_protocol::ToolId::new("hashline_edit").expect("valid tool id")
    }
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, sentinel_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<sentinel_tool_runtime::Cwd>() {
            ...
            let scheme = params
                .0
                .build_scheme()
                .map_err(sentinel_tool_runtime::ToolError::invalid_arguments)?;
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::ai_build_hashline::anchor::split_lines;
        use crate::implementations::ai_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::ai_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    fn test_scheme() -> Box<dyn crate::implementations::ai_build_hashline::scheme::AnchorScheme> {
        crate::implementations::ai_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
