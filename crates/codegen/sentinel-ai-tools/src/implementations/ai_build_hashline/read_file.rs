...
//!
//! Reuses the core file-reading logic from [`ai_build::read_file::run_read_file`]
...
use crate::implementations::ai_build::read_file::{ReadFileInput, run_read_file};
...
impl sentinel_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> sentinel_tool_protocol::ToolId {
        sentinel_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::ai_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of ai_build `read_file`).
    #[tokio::test]
