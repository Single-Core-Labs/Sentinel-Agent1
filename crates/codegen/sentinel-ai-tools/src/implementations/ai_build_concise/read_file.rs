...
impl sentinel_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // AiBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::ai_build::read_file::ReadFileTool;
