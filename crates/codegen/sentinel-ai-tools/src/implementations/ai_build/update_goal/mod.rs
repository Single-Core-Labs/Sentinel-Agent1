...
pub use sentinel_ai_tools_api::slash_commands::UPDATE_GOAL_TOOL_NAME;
...
impl sentinel_tool_runtime::ToolOutput for UpdateGoalOutput {}
...
impl sentinel_tool_runtime::Tool for UpdateGoalTool {
    type Args = UpdateGoalInput;
    type Output = UpdateGoalOutput;

    fn id(&self) -> sentinel_tool_protocol::ToolId {
        sentinel_tool_protocol::ToolId::new(UPDATE_GOAL_TOOL_NAME).expect("valid tool id")
    }
    ...
    ) -> Result<UpdateGoalOutput, sentinel_tool_runtime::ToolError> {
