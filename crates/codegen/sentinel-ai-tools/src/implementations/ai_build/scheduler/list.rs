...
impl sentinel_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl crate::types::tool_metadata::ToolMetadata for SchedulerListTool {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        Expr::Value(ToolRequirement::Tool {
            ...
            id: sentinel_tool_runtime::Tool::id(&SchedulerCreateTool).to_string(),
            if_params: None,
        })
    }
}

impl sentinel_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> sentinel_tool_protocol::ToolId {
        sentinel_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, sentinel_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                sentinel_tool_runtime::ToolError::execution(
                    sentinel_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
