...
pub fn scheduler_tool_error(error: SchedulerError) -> sentinel_tool_runtime::ToolError {
    ...
    sentinel_tool_runtime::ToolError::custom(code, error.to_string())
}
...
crate::register_resource!("ai_build", "Scheduler", SchedulerState);
