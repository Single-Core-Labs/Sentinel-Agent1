...
pub const USER_AGENT_STRING: &str = "Mozilla/5.0 (compatible; ai-agent/1.0; +https://x.ai)";
...
pub struct WebFetchParams {
    ...
    /// allow_local = true` or `AI_WEB_FETCH_ALLOW_LOCAL=1`.
    #[serde(default)]
    pub allow_local: Option<bool>,
}

register_resource!("ai_build", "WebFetch", WebFetchParams);
