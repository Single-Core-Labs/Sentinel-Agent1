...
crate::register_resource!("ai_build", "ListDir", ListDirParams);
...
impl sentinel_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(sentinel_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
