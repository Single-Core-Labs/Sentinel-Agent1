...
impl sentinel_tool_runtime::ToolOutput for MonitorOutput {}
...
pub struct MonitorEventNotification {
    ...
    /// events inside another session's turn. `None` for legacy / non-ai-build
...
///
/// [`EventQueue`]: sentinel_interjection_core::EventQueue
pub type MonitorEventBuffer = sentinel_interjection_core::EventQueue<MonitorEventNotification>;

crate::register_resource!("ai_build", "MonitorEventBuffer", MonitorEventBuffer);
