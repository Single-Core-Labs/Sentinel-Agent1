...
impl sentinel_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> sentinel_tool_protocol::ToolId {
        sentinel_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                sentinel_tool_runtime::ToolError::execution(
                    sentinel_tool_protocol::ToolId::new("memory_search").expect("valid"),
