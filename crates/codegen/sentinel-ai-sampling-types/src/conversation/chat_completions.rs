...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            x_ai_conv_id: req.x_ai_conv_id,
            x_ai_req_id: req.x_ai_req_id,
            x_ai_session_id: req.x_ai_session_id,
            x_ai_turn_idx: req.x_ai_turn_idx,
            x_ai_agent_id: req.x_ai_agent_id,
            x_ai_deployment_id: req.x_ai_deployment_id,
            x_ai_user_id: req.x_ai_user_id,
            trace: None,
        }
    }
}
