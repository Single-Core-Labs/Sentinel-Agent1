...
//!
//! Run with: cargo run -p sentinel-ratatui-textarea --example textarea_demo
//!
...
use sentinel_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use sentinel_ratatui_textarea::{
