...
fn ambient_ctx_injects_session_turn_and_prompt_id() {
    ...
    let ctx = sentinel_ai_telemetry::TelemetryCtx::new(
        "sess-ctx".to_owned(),
    ...
    rt.block_on(sentinel_ai_telemetry::with_session_ctx(ctx, async {
        sentinel_ai_telemetry::session_ctx::begin_prompt_id();
