...
//!
//! Run with: cargo test -p sentinel-ai-mcp --test repro_sse_flood -- --nocapture
...
use sentinel_ai_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use sentinel_ai_mcp::rmcp::ServiceExt;
use sentinel_ai_mcp::rmcp::transport::StreamableHttpClientTransport;
use sentinel_ai_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
