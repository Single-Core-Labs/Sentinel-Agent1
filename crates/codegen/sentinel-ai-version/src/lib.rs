//! Installed ai CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "AI_TEST_VERSION";

pub const VERSION: &str = match option_env!("AI_VERSION") {
    Some(v) => v,
