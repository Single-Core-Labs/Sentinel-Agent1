...
//!
//! ```text
//! cargo bench -p sentinel-ai-shell --bench skills_watcher_startup
//! # optional scale:
//! AI_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p sentinel-ai-shell --bench skills_watcher_startup
//! ```
//!
...
fn build_fixture(worktree_dirs: usize) -> Fixture {
    ...
    let ai_home = root.path().join("ai-home");
