//! Shared helpers for sentinel-ai-shell integration tests.

use sentinel_ai_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use sentinel_ai_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `sentinel_ai_sampler::SamplingClient`, which takes a
