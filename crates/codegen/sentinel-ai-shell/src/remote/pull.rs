...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* ai_home (where this hydrated copy lives),
            // not the original remote session's, since reconstruction runs locally.
            ai_home: crate::session::persistence::ai_home_string(),
            last_active_at: None,
            ...
            sandbox_profile: sentinel_ai_sandbox::configured_profile_name().map(String::from),
