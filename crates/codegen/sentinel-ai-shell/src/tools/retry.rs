//! Retry utilities — re-exported from `sentinel-ai-tools`.
//!
//! The canonical implementation now lives in `sentinel_ai_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use sentinel_ai_tools::retry::BackoffConfig as RetryConfig;
pub use sentinel_ai_tools::retry::{BackoffConfig, execute_with_backoff};
