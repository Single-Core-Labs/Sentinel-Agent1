//! Todo types — re-exported from `sentinel-ai-tools` with ACP conversion helpers.
//!
//! Types are canonical in `sentinel-ai-tools`. This module adds ACP ↔ TodoItem
//! conversions since `sentinel-ai-tools` is protocol-agnostic.

pub use sentinel_ai_tools::implementations::ai_build::todo::TodoId;
pub use sentinel_ai_tools::implementations::ai_build::todo::TodoItem;
pub use sentinel_ai_tools::implementations::ai_build::todo::TodoPriority;
pub use sentinel_ai_tools::implementations::ai_build::todo::TodoState;
pub use sentinel_ai_tools::implementations::ai_build::todo::TodoStatus;
