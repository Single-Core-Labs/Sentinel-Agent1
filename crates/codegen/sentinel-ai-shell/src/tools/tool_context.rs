...
//! sentinel-ai-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use sentinel_ai_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use sentinel_ai_workspace::session::file_state::FileStateHandle;
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> sentinel_ai_tools::implementations::ai_build::task::types::SubagentForegroundWait {
    sentinel_ai_tools::implementations::ai_build::task::types::SubagentForegroundWait::new(
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn sentinel_ai_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<sentinel_ai_tools::implementations::ai_build::monitor::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<sentinel_ai_tools::reminders::task_completion::TaskWakeSuppressed>,
