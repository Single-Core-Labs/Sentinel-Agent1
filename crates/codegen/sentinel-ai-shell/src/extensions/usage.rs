...
//!
//! Projects the in-memory [`sentinel_chat_state::UsageLedger`] (main-loop + folded
...
mod tests {
    use super::*;
    use sentinel_chat_state::UsageLedger;
    ...
    fn response_serializes_ledger_as_prompt_usage_wire_shape() {
        ...
        ledger.record_main_loop_call("ai-build", &usage(100, 10), Some(50), Some(20_000_000));
        ...
        assert_eq!(v["usage"]["modelUsage"]["ai-build"]["inputTokens"], 100);
