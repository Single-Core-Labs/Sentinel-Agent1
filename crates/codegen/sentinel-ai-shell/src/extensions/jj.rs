//! Jujutsu extension handlers — delegates to [`sentinel_ai_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use sentinel_ai_workspace::session::git::{CommitData, StageData};
use sentinel_ai_workspace::session::jj;
