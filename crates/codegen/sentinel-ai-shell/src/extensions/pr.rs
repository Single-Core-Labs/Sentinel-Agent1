...
mod tests {
    ...
    fn gh_pr_view_json_parses_after_stripping_forced_color() {
        ...
        assert_eq!(
            parsed.url.as_deref(),
            Some("https://github.com/sentinel-org/sentinel/pull/242682")
        );
    }
