...
//! (SuperAi, SuperAi Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("SuperAi"));
        assert!(!is_restricted_tier_name("SuperAi Heavy"));
        assert!(!is_restricted_tier_name("superai_lite"));
