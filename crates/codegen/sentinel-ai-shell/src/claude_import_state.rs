...
//
// State is persisted to `~/.ai/claude_import_state.json`.
...
use sentinel_ai_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.ai/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::ai_home::ai_home().join("claude_import_state.json")
}
