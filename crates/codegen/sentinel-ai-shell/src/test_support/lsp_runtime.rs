...
pub(crate) type GatewayOut = <acp::AgentSide as sentinel_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        sampling_config: sentinel_ai_sampler::SamplerConfig {
            api_key: None,
            base_url: String::new(),
            model: String::new(),
        ...
        hunk_tracker_handle: sentinel_hunk_tracker::HunkTrackerHandle::noop(),
        hunk_tracking_enabled: false,
        fs: Arc::new(sentinel_ai_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        hook_registry: None,
        parent_depth: 0,
        subagents_max_depth: sentinel_ai_tools::implementations::ai_build::task::MAX_SUBAGENT_DEPTH,
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-ai-test"),
        ...
        parent_skills: None,
        parent_skills_config: sentinel_ai_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: sentinel_ai_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: sentinel_ai_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl sentinel_ai_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &sentinel_ai_tools::implementations::lsp::LspToolInput,
    ) -> sentinel_ai_tools::implementations::lsp::LspToolResult {
        sentinel_ai_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<sentinel_ai_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<sentinel_ai_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
