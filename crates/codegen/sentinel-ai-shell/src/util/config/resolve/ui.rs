...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "AI_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`AI_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "AI_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`AI_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "AI_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`AI_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `AI_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("AI_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes AI_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
