//! `AcpTerminalAdapter`: implements `sentinel-ai-tools::TerminalBackend` over ACP
...
use sentinel_acp_lib::{AcpAgentGatewaySender as GatewaySender, acp_channel_failure};
use sentinel_ai_tools::computer::types::{
...
/// Wraps sentinel-ai-shell's ACP gateway to satisfy sentinel-ai-tools' TerminalBackend.
