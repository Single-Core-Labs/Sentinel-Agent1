...
impl MvpAgent {
    ...
    pub(crate) fn remove_session(&self, id: &acp::SessionId) {
        let _ = self
            .subagent_event_tx
            .send(sentinel_ai_tools::implementations::ai_build::task::types::SubagentEvent::TeardownSession {
        ...
        self.log_resource_usage(sentinel_ai_telemetry::events::ResourceReportTrigger::SessionClose);
    }
