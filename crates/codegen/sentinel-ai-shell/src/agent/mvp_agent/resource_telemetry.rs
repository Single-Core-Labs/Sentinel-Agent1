...
use sentinel_ai_telemetry::events::ResourceReportTrigger;
...
impl MvpAgent {
    ...
    pub(super) fn report_resource_usage_if_due(&self) {
        let memory = sentinel_tty_utils::sample_process_memory();
