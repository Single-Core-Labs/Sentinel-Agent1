...
mod tests {
    ...
    fn parse_queue_edit_command_maps_each_method() {
        ...
        match parse_queue_edit_command("x.ai/queue/remove", &p, Some("ai-tui".into())) {
            Some(SessionCommand::RemoveQueuedPrompt {
                id,
                expected_version,
                owner,
        ...
        match parse_queue_edit_command("x.ai/queue/edit", &p, Some("ai-vscode".into())) {
            Some(SessionCommand::EditQueuedPrompt {
                id,
                new_text,
                editor,
        ...
        match parse_queue_edit_command("x.ai/queue/interject", &p, Some("ai-tui".into())) {
            Some(SessionCommand::InterjectQueuedPrompt {
                id,
                expected_version,
                owner,
