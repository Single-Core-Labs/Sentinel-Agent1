...
//! `sentinel_ai_sampling_types` plus ai-shell-specific additions.

use std::collections::HashSet;

pub use sentinel_ai_sampling_types::conversation::*;
...
/// through its blanket impl. Lives in ai-shell because it references
...
/// `count_complete_turns` in `sentinel-ai-subagent-resolution/src/context.rs`.
