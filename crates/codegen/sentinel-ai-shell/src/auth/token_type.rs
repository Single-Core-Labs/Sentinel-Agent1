...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&AiAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> sentinel_ai_telemetry::events::AuthTokenKind {
        use sentinel_ai_telemetry::events::AuthTokenKind as K;
        match self {
