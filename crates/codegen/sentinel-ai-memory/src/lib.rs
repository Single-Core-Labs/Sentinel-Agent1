...
//! Ai to persist important information across sessions. Memory files are
//! stored under `~/.ai/memory/` with workspace-scoped subdirectories
...
//! `AI_MEMORY=1` environment variable. When disabled, this crate
