...
/// The tail, not the head: JWTs share a base64 header and AI keys a prefix.
...
mod tests {
    ...
    fn bearer_suffix_semantics() {
        for (input, expected) in [
            // The tail, not the head: JWT headers and AI key prefixes are shared.
            ("eyJ0eXAiOiJh.shared-head.tail-distinct", "ail-distinct"),
            ("sentinel-key-aaaaaaaaaaadistinct1", "aaadistinct1"),
