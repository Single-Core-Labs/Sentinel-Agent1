...
//! `sentinel_ai_shell::session::git` and `sentinel_ai_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `sentinel_ai_shell::session::git::VcsKind`.
