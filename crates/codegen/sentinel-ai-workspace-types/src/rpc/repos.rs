...
//! in-sandbox manifest contract (`{workspace}/.ai/repos.json`).
//!
...
pub const REPOS_MANIFEST_RELATIVE_PATH: &str = ".ai/repos.json";
...
impl RepoManifest {
    ...
    /// Parse bytes from `{workspace}/.ai/repos.json`.
