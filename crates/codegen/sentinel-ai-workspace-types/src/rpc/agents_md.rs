...
/// Claude.md / `.ai/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.ai` and compat dirs.
...
/// Mirrors the serde shape of `sentinel-ai-agent`'s `AgentConfigFile`.
