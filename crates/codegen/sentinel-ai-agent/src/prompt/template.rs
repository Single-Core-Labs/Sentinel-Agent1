...
/// The base prompt template source, exposed for `ai prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `ai prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard ai-build tool kinds.
