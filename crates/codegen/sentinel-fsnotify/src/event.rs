//! Public event types — the wire contract for `sentinel-fsnotify`.
//!
...
//! translator (in `sentinel-ai-workspace`) maps these to
...
/// Aligned with `sentinel_ai_workspace_types::FsEventKind` (identity map at
