...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    sentinel_ai_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        sentinel_ai_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        sentinel_ai_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        sentinel_ai_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        sentinel_ai_shell::session::PromptOrigin::TaskCompleted { .. }
            | sentinel_ai_shell::session::PromptOrigin::SubagentCompleted { .. }
            | sentinel_ai_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | sentinel_ai_shell::session::PromptOrigin::NotificationDrain
    )
}
