...
fn upsert_workflow_block(
    ...
    objective: &str,
    status: &str,
    phases: &[sentinel_ai_shell::extensions::notification::WorkflowPhaseInfo],
...
pub(super) fn ingest_workflow_update(agent: &mut AgentView, update: AiSessionUpdate) -> bool {
    let AiSessionUpdate::WorkflowUpdated {
        run_id,
        revision,
        name,
        objective,
