...
impl AgentView {
    ...
    pub fn draw(
        ...
        if let Some(profile) = sentinel_ai_sandbox::profile_name() {
        ...
        let sticky_gap_row: Option<u16>;
        {
                ...
                && let Some(search) = self.scrollback_search.as_ref()
            {
                ...
                crate::views::picker::render_search_bar_with_viewport(
                    ...
                    !search.is_composing(),
                    None,
                    viewport.unwrap_or(sentinel_ratatui_textarea::SingleLineViewport {
            ...
            if route.emit_osc8 {
                ...
                *link_spans_out = self
                    ...
                    .filter_map(|link| {
                        ...
                        .map(|url| sentinel_ratatui_inline::LinkSpan {
                            row: link.screen_row,
...
mod toast_fit_tests {
    ...
    fn long_message_truncates_with_ellipsis_instead_of_vanishing() {
        let msg = "Copied via OSC 52 — also saved to /tmp/ai-0/last-copy.txt. If paste fails, hold Shift (or Fn) and drag to select & copy natively.";
