...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        sentinel_ai_telemetry::session_ctx::log_event(sentinel_ai_telemetry::events::PromptSuggestion {
            action: sentinel_ai_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        sentinel_ai_telemetry::session_ctx::log_event(
            sentinel_ai_telemetry::events::PluginCtaConnectClicked {
        ...
        self.pending_effects
            .push(super::actions::Effect::InstallPluginFromCta {
                agent_id: self.session.id,
                session_id,
                source_url_or_path: sentinel_ai_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL
                    .to_string(),
                plugin_relative_path,
            });
    }
...
mod prompt_suggestion_gate_tests {
    ...
    fn an_open_question_card_closes_the_suggestion_gate() {
        ...
        use sentinel_ai_tools::implementations::ai_build::ask_user_question::Question;
...
mod plugin_cta_notify_tests {
    ...
    fn cta_entry(name: &str) -> sentinel_hooks_plugins_types::MarketplacePluginEntry {
