    ...
    fn handle_input_inner(
            ...
            && registry.lookup(key, When::AgentScreen) == Some(ActionId::OpenExtensions)
        {
            ...
            return InputOutcome::Action(Action::OpenExtensionsModal {
                ...
                trigger: sentinel_ai_telemetry::events::ExtensionsModalTrigger::KeyboardShortcut,
            });
        }
        if let Event::Key(key) = ev
            && key.kind != KeyEventKind::Release
...
mod esc_would_cancel_turn_tests {
    ...
    fn queued_edit_and_inline_edit_steal_esc() {
        ...
        agent.inline_edit = Some(crate::app::inline_edit::InlineEditState {
            ...
            prompt_index: 0,
            original: "sent".into(),
            textarea: sentinel_ratatui_textarea::TextArea::new(),
            textarea_state: sentinel_ratatui_textarea::TextAreaState::default(),
            last_text_area: None,
            last_rect: None,
        });
        assert!(
...
mod rich_textarea_paste_routing_tests {
    ...
    use crossterm::event::Event;
    use sentinel_ratatui_textarea::{TextArea, TextAreaState};
    #[test]
