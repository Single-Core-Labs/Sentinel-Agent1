...
impl AgentView {
    ...
    pub(super) fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        ...
        sentinel_ai_telemetry::session_ctx::log_event(sentinel_ai_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            sentinel_ai_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
    ...
    fn ctrl_f_is_noop_for_protected_edit_description() {
        ...
        perm.options = vec![
            option("allow-once", acp::PermissionOptionKind::AllowOnce),
            option(
                sentinel_ai_workspace::permission::ALLOW_EDITS_SESSION_OPTION_ID,
                acp::PermissionOptionKind::AllowAlways,
            ),
            option("reject-once", acp::PermissionOptionKind::RejectOnce),
        ];
...
mod question_no_freeform_tests {
    ...
    //! the SuperAi upsell. Regression tests for the bug where clicking
    ...
    fn upsell_question() -> Question {
        ...
        Question {
            ...
            options: vec![
                opt("Upgrade to SuperAi", "For everyday coding"),
                opt("Upgrade to SuperAi Heavy", "Highest usage limits"),
            ],
