    ...
    let response = sentinel_hooks_plugins_types::MarketplaceListResponse {
        sources: vec![
            ...
            sentinel_hooks_plugins_types::MarketplaceScanResult {
                ...
                source_kind: "git".into(),
                source_url_or_path: "git@github.com:sentinel-org/plugin-marketplace.git".into(),
...
mod cta_e2e {
    ...
    fn figma_candidate() -> sentinel_hooks_plugins_types::MarketplacePluginEntry {
        let mut entry = cta_entry("figma", "not_installed");
    ...
    fn happy_path_with_auth_handoff() {
        ...
        let servers = vec![
            cta_mcp_server("ai_com_managed", None, McpServerDisplayStatus::Ready),
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = sentinel_ai_shell::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        sentinel_ai_shell::config::add_dismissed_plugin_cta_to_file("figma", &config_path)
