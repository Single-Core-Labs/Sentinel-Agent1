...
use sentinel_acp_lib::AcpResult;
use sentinel_ai_markdown::StreamingMarkdownRenderer;
pub use sentinel_ai_tools::implementations::ai_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<sentinel_ai_telemetry::events::CreditLimitChoice>,
    },
    /// SuperAi upsell modal: the free-usage paywall (429 +
    ...
    /// `id`.
    FreeUsageUpsell {
        /// Telemetry source for `SuperAiUpsellClicked` — distinguishes
        /// the paywall from the restricted-command upsell.
        source: sentinel_ai_telemetry::events::SuperAiUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<sentinel_ai_shell::sampling::types::ReasoningEffort>,
    },
    DoctorFix {
...
impl QuestionViewState {
    ...
    /// questions (e.g. the SuperAi upsell) have no freeform row, so
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> sentinel_ai_tools::implementations::ai_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: sentinel_ai_tools::implementations::ai_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    /// `no_freeform` questions (e.g. the SuperAi upsell) have no "Other"
    ...
    fn chrome_height_option_less_question_drops_the_label_gap() {
        ...
        let q = make_question("How can we improve Ai Build?", &[], false);
        assert_eq!(
            chrome_height(
                &q,
                80,
