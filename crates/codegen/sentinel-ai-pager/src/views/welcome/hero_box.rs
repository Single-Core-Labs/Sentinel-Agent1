...
const HERO_SUBTITLE: &str = "Thanks for trying Ai Build, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&sentinel_ai_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Ai 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Ai 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(sentinel_ai_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/ai".into()),
        ...
        let mut dismissible = ann(None, Some("Ai 4.5 is here. Upgrade now."));
        dismissible.cta = Some(sentinel_ai_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/ai".into()),
            caption: Some("or use Ctrl+O".into()),
        });
