...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> sentinel_ratatui_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<sentinel_ai_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(file_label("/home/user/.ai/memory/MEMORY.md"), "MEMORY.md");
        assert_eq!(
            file_label("/workspace/.ai/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use sentinel_ai_shell::extensions::notification::MemoryFileInfo;
