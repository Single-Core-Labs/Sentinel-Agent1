...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. AiNight's dark band leaking into AiDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default AiNight, dark) after the user switches —
        // painting a dark band on a light AiDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use sentinel_ratatui_textarea::ClipboardProvider;
