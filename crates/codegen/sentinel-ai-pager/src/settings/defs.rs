...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain ai in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain ai in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `sentinel_ai_voice::STT_LANGUAGES` (official Ai STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain ai opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "ainight".
                default: "ainight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ainight".
                default: "ainight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "aiday".
                default: "aiday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "ai", "switch"],
        ...
        // The `AI_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Opt-in to provide SpaceAI the ability to retain and train on \
        ...
        // follows the process locale when it maps to a Ai STT language.
        // Catalog = official STT languages (see sentinel_ai_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Ai STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "Show a `/doctor` tip when an SSH session is not using `ai wrap`.",
            keywords: &[
                "ssh",
                "wrap",
                "remote",
