...
use sentinel_ai_tools::types::output::SearchReplaceEditDetail;
...
pub fn extract_edit_hunks(tc: &agent_client_protocol::ToolCall) -> (Vec<DiffHunk>, usize) {
    use sentinel_ai_tools::types::output::{
...
mod tests {
    ...
    fn extract_edit_hunks_from_diff_meta_structured() {
        ...
        use agent_client_protocol as acp;
        use std::sync::Arc;
        use sentinel_ai_tools::types::output::SearchReplaceEditContextInformation;
