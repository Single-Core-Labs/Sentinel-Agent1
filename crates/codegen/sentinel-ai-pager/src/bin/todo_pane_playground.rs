...
//!
//! ```text
//! cargo run -p sentinel-ai-pager --bin todo-pane-playground
//! ```
//!
...
use sentinel_ai_pager::views::todo_pane::TodoPane;
use sentinel_ai_shell::tools::{TodoItem, TodoPriority, TodoStatus};
