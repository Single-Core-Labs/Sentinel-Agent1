...
impl SleepInhibitor {
    ...
    fn platform_inhibit(&self) -> bool {
        ...
        let reason = core_foundation::string::CFString::new("ai: agent turn in progress");
        let assertion_type =
