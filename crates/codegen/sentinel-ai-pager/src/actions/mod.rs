...
/// Emit [`sentinel_ai_telemetry::events::ShortcutUsed`] for an allowlisted binding.
///
...
pub fn log_shortcut_used(key: &KeyEvent, action_id: ActionId, context: &str) {
    ...
    sentinel_ai_telemetry::session_ctx::log_event(sentinel_ai_telemetry::events::ShortcutUsed {
