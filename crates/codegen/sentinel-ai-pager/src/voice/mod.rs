...
//!   Absent remote falls through to on. `AI_VOICE_MODE` overrides for local
//!   dev (env > remote > default on). Free/X Basic still get SuperAi upsell
...
pub use sentinel_ai_voice::maybe_run_capture_subprocess;
