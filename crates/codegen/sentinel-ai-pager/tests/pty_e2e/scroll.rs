...
use sentinel_ai_pager_pty_harness::PtyHarness;
pub(crate) use sentinel_ai_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`sentinel-ai-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `sentinel-ai-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
...
/// (e.g. `AI_SCROLL_SPEED`) appended to the controller's env.
