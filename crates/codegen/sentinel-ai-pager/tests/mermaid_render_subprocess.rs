...
use sentinel_ai_pager::app::mermaid_worker::render_via_subprocess;
use sentinel_ai_pager::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `sentinel_ai_mermaid::subprocess` `reap_terminates_the_process` unit test;
