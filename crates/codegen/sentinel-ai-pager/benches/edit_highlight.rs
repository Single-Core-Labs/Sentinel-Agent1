...
//!
//! ```text
//! cargo bench -p sentinel-ai-pager --bench edit_highlight
//! cargo bench -p sentinel-ai-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use sentinel_ai_pager::diff::{DiffHunk, DiffLine};
use sentinel_ai_pager::scrollback::blocks::tool::{
...
use sentinel_ai_pager::syntax::{Syntect, get_syntect};
