//! Criterion benchmarks for the sentinel-ai-pager rendering pipeline.
//!
...
use sentinel_ai_pager::scrollback::render::render_scrolled_entries_with_scratch;
use sentinel_ai_pager::scrollback::wrappers::EntryRenderer;
use sentinel_ai_pager::scrollback::{
