#!/bin/bash
#
# Ai CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
#   AI_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
