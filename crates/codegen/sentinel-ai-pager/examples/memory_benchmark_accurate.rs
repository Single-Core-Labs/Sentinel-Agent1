...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "ai-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "ai-3", "researcher");
    ...
    let shared_models = ["ai-3", "ai-3-mini"];
