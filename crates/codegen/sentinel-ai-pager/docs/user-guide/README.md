...
Learn how to install, configure, and extend Ai Build, the terminal-based AI coding assistant from SpaceAI.
...
Automate, script, and integrate Ai Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `ai -p`, output formats, CI/CD integration, and piping |
