...
Want Ai working on a feature while you (or another Ai session) work on
...
- **From the shell:**
  ...
  ```bash
  ai --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Ai sessions on the same repo simultaneously.
