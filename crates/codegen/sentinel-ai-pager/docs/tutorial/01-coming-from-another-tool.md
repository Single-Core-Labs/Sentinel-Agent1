...
Fear not — your settings, rules, and skills come with you. Ai Build
...
writes the items you selected into your `.ai` config. Re-run it anytime.
...
Run **`ai inspect`** in a repo to see every rules file, skill, and MCP
server Ai picked up, tagged with where it came from. Each compat source
