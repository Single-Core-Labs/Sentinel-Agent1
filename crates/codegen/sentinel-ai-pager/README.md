...
Terminal UI (TUI) for Ai Build. Provides the interactive full-screen interface
...
- [Hook Examples](../sentinel-ai-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`sentinel-ai-hooks`)](../sentinel-ai-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`sentinel-ai-plugin-marketplace`)](../sentinel-ai-plugin-marketplace/) — marketplace source loading, scanning, and install
