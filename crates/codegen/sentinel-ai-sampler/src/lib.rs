//! sentinel-ai-sampler - Actor-based sampling layer for AI ai.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `sentinel-ai-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `sentinel-hunk-tracker`.
//!
//! ## Layered API
//!
