...
use sentinel_ai_sampler::{SamplerConfig, SamplingClient};
...
use sentinel_ai_test_support::{MockInferenceServer, ScriptedResponse};
...
<html lang="en-US">
<head><title>ai.com | 522: Connection timed out</title></head>
<body>
...
async fn stream_err(status: u16, body: &str) -> sentinel_ai_sampling_types::SamplingError {
