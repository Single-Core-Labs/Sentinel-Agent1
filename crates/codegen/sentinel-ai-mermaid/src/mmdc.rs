...
//!
//! Security: the subprocess is spawned with [`sentinel_tty_utils::detach_std_command`]
//! (TTY/session detach) + [`sentinel_tty_utils::pager_env`] + null stdio, source is
