...
/// WSL detection. The implementation lives in `sentinel-tty-utils` (the shared
...
pub use sentinel_tty_utils::is_wsl;
...
// tests live with the implementation in `sentinel-tty-utils`.
