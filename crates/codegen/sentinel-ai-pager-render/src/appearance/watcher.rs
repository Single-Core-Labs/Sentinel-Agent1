...
//!
//! In dev mode, watches ~/.ai/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.ai/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.ai/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = sentinel_ai_config::user_ai_home()
