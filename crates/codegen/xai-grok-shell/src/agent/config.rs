...
"#;
    ...
    fn worktree_auto_gc_section_parses_from_toml() {
        unsafe {
            unsafe { std::env::remove_var(xai_fast_worktree::ENV_AUTO_GC) };
            unsafe { std::env::remove_var(xai_fast_worktree::ENV_AUTO_GC_DRY_RUN) };
            unsafe { std::env::remove_var(xai_fast_worktree::ENV_AUTO_GC_MAX_AGE) };
        }
        let raw: toml::Value = toml::from_str(
            r#"
            [worktree.auto_gc]
    ...
    fn clear_goal_envs() {
        unsafe {
            unsafe { std::env::remove_var("GROK_GOAL") };
            unsafe { std::env::remove_var("GROK_GOAL_CLASSIFIER") };
            unsafe { std::env::remove_var("GROK_GOAL_PLANNER") };
            unsafe { std::env::remove_var("GROK_GOAL_SUMMARY") };
...
"#,
    ...
    fn clear_runtime_env_vars() {
        unsafe {
            unsafe { std::env::remove_var("GROK_SUBAGENTS") };
            unsafe { std::env::remove_var("GROK_RESPECT_GITIGNORE") };
            unsafe { std::env::remove_var("GROK_WEB_SEARCH_MODEL") };
            unsafe { std::env::remove_var("GROK_SESSION_SUMMARY_MODEL") };
            unsafe { std::env::remove_var("GROK_CURSOR_SKILLS_ENABLED") };
            unsafe { std::env::remove_var("GROK_CURSOR_RULES_ENABLED") };
            unsafe { std::env::remove_var("GROK_CURSOR_AGENTS_ENABLED") };
            unsafe { std::env::remove_var("GROK_CLAUDE_SKILLS_ENABLED") };
            unsafe { std::env::remove_var("GROK_CLAUDE_RULES_ENABLED") };
            unsafe { std::env::remove_var("GROK_CLAUDE_AGENTS_ENABLED") };
        }
    }
    fn clear_managed_mcp_env_vars() {
        unsafe {
            unsafe { std::env::remove_var("GROK_MANAGED_MCPS_ENABLED") };
            unsafe { std::env::remove_var("GROK_MANAGED_MCP_GATEWAY_TOOLS_ENABLED") };
        }
    }
