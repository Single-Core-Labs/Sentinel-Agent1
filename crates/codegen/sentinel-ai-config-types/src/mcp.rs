//! MCP server configuration value types, extracted from sentinel-ai-shell
...
use sentinel_ai_mcp::oauth_config::McpOAuthConfig;
...
/// and surfaced through `ai inspect`.
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("AI_RELAY_SYNC_ENABLED") {
