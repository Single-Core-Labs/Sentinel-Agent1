...
// its wire types live in `sentinel_ai_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use sentinel_ai_workspace_types::rpc::fs::FsReadEncoding;
...
pub use sentinel_ai_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
