//! AcpFsAdapter: implements `sentinel-ai-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates sentinel-ai-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use sentinel_ai_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps sentinel-ai-shell's ACP gateway to satisfy sentinel-ai-tools' AsyncFileSystem.
///
