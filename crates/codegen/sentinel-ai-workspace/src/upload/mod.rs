...
use sentinel_file_utils::gcs::StorageConfig;
use sentinel_file_utils::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use sentinel_file_utils::storage_client::Auth401AttributionCallback;
use sentinel_file_utils::{TraceExportConfig, UploadMethod};
use sentinel_ai_auth::{AuthCredentialProvider, CredentialSnapshot};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ai_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ai_workspace_upload_queue_pending",
...
static UPLOAD_OUTCOME_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ai_workspace_upload_outcome_total",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ai_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ai_workspace_upload_skipped_total",
...
impl sentinel_ai_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use sentinel_computer_hub_sdk::auth::AuthCredential;
