...
use sentinel_ai_workspace_types::rpc::export_github::{ExportGithubError, ExportGithubResponse};
...
const AUTHOR_NAME: &str = "Ai";
const AUTHOR_EMAIL: &str = "ai-export@users.noreply.github.com";
...
async fn commit_if_dirty(dir: &Path, message: Option<&str>) -> Result<bool, ExportGithubFailure> {
    ...
    let message = message.unwrap_or("Export from Ai");
