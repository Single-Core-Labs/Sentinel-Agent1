...
pub const ARCH_SPECS: &[ArchSpec] = &[
    ArchSpec { name: "GTX 1080 Ti", compute_cap: "6.1", family: "Pascal", sm_count: 28, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 98304, register_file_size: 65536, l1_cache_per_sm: 49152, l2_cache_size: 1572864, core_clock_mhz: 1582, mem_bandwidth_gbps: 484.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: false, fp64_throughput_ratio: 0.03125 },
    ArchSpec { name: "Tesla V100", compute_cap: "7.0", family: "Volta", sm_count: 80, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 98304, register_file_size: 65536, l1_cache_per_sm: 131072, l2_cache_size: 6291456, core_clock_mhz: 1530, mem_bandwidth_gbps: 900.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.5 },
    ArchSpec { name: "RTX 2080 Ti", compute_cap: "7.5", family: "Turing", sm_count: 68, warps_per_sm: 64, max_threads_per_sm: 1024, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 65536, register_file_size: 65536, l1_cache_per_sm: 98304, l2_cache_size: 5767168, core_clock_mhz: 1545, mem_bandwidth_gbps: 616.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.0625 },
    ArchSpec { name: "A100", compute_cap: "8.0", family: "Ampere", sm_count: 108, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 167936, register_file_size: 65536, l1_cache_per_sm: 131072, l2_cache_size: 41943040, core_clock_mhz: 1410, mem_bandwidth_gbps: 1555.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.5 },
    ArchSpec { name: "RTX 3090", compute_cap: "8.6", family: "Ampere", sm_count: 82, warps_per_sm: 64, max_threads_per_sm: 1536, max_blocks_per_sm: 16, max_threads_per_block: 1024, shared_mem_per_sm: 131072, register_file_size: 65536, l1_cache_per_sm: 131072, l2_cache_size: 6291456, core_clock_mhz: 1695, mem_bandwidth_gbps: 936.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.03125 },
    ArchSpec { name: "RTX 4090", compute_cap: "8.9", family: "Ada Lovelace", sm_count: 128, warps_per_sm: 64, max_threads_per_sm: 1536, max_blocks_per_sm: 16, max_threads_per_block: 1024, shared_mem_per_sm: 131072, register_file_size: 65536, l1_cache_per_sm: 131072, l2_cache_size: 7340032, core_clock_mhz: 2520, mem_bandwidth_gbps: 1008.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.015625 },
    ArchSpec { name: "H100", compute_cap: "9.0", family: "Hopper", sm_count: 132, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 232448, register_file_size: 65536, l1_cache_per_sm: 262144, l2_cache_size: 52428800, core_clock_mhz: 1980, mem_bandwidth_gbps: 3352.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.5 },
    ArchSpec { name: "H200", compute_cap: "9.2", family: "Hopper", sm_count: 132, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 232448, register_file_size: 65536, l1_cache_per_sm: 262144, l2_cache_size: 52428800, core_clock_mhz: 1980, mem_bandwidth_gbps: 4800.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.5 },
    ArchSpec { name: "RTX 5090", compute_cap: "10.0", family: "Blackwell", sm_count: 170, warps_per_sm: 64, max_threads_per_sm: 1536, max_blocks_per_sm: 16, max_threads_per_block: 1024, shared_mem_per_sm: 131072, register_file_size: 65536, l1_cache_per_sm: 262144, l2_cache_size: 12582912, core_clock_mhz: 2520, mem_bandwidth_gbps: 1792.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.015625 },
    ArchSpec { name: "B200", compute_cap: "10.2", family: "Blackwell", sm_count: 168, warps_per_sm: 64, max_threads_per_sm: 2048, max_blocks_per_sm: 32, max_threads_per_block: 1024, shared_mem_per_sm: 232448, register_file_size: 65536, l1_cache_per_sm: 262144, l2_cache_size: 62914560, core_clock_mhz: 1980, mem_bandwidth_gbps: 8000.0, warp_size: 32, shared_mem_banks: 32, tensor_cores: true, fp64_throughput_ratio: 0.5 },
];

pub fn arch_by_name(name: &str) -> Option<&'static ArchSpec> {
    ARCH_SPECS.iter().find(|a| a.compute_cap == name || a.name.eq_ignore_ascii_case(name))
}
...
impl Default for LaunchConfig {
    fn default() -> Self {
        LaunchConfig { grid_x: 1, grid_y: 1, grid_z: 1, block_x: 256, block_y: 1, block_z: 1, shared_mem_bytes: 0, registers_per_thread: 32 }
    }
}
...
pub fn extract_instruction_profile(source: &str, config: &LaunchConfig) -> InstructionProfile {
    let total_threads = config.block_x as u64 * config.block_y as u64 * config.block_z as u64 * config.grid_x as u64 * config.grid_y as u64 * config.grid_z as u64;
    ...
    for line in &lines {
        ...
        if trimmed.contains("/*") { in_comment_block = true; }
        if in_comment_block {
        ...
        if trimmed.contains("__syncthreads") || trimmed.contains("__syncwarp") || trimmed.contains("__threadfence") {
            sync_instructions += 1;
        }

        if trimmed.contains("if ") || trimmed.contains("else ") || trimmed.contains("switch ") || trimmed.contains("? ") || trimmed.contains("return ") {
        ...
        let has_global_load = trimmed.contains('[') || trimmed.contains("__ldg") || trimmed.contains("__ldca") || trimmed.contains("__ldcg") || trimmed.contains("ld.global");
        let has_global_store = (trimmed.contains('=') && trimmed.contains('[')) || trimmed.contains("__stg") || trimmed.contains("st.global");
        let has_shared_load = trimmed.contains("__lds") || trimmed.contains("ld.shared") || trimmed.contains("s_data[") || trimmed.contains("shared[") || trimmed.contains("__shared__");
        let has_shared_store = trimmed.contains("__sts") || trimmed.contains("st.shared") || (trimmed.contains('=') && (trimmed.contains("s_data[") || trimmed.contains("shared[")));

        if has_global_load { global_loads += 1; }
        if has_global_store { global_stores += 1; }
        if has_shared_load { shared_loads += 1; }
        if has_shared_store { shared_stores += 1; }

        if trimmed.contains("__fmaf") || trimmed.contains("fmaf") || trimmed.contains("__fma") || trimmed.contains("fma(") || trimmed.contains("hfma") {
            arith_fma += 1;
        }
        if trimmed.contains("__hmul") || trimmed.contains("__fmul") || trimmed.contains("mul") || (trimmed.contains('*') && !trimmed.contains("**")) {
            arith_mul += 1;
        }
        if trimmed.contains("__hadd") || trimmed.contains("__fadd") || trimmed.contains("add") || trimmed.contains("+=") || trimmed.contains("+") {
            arith_add += 1;
        }
        ...
        if trimmed.contains("wmma") || trimmed.contains("mma.") || trimmed.contains("tensor_core") || trimmed.contains("tcgen") || trimmed.contains("TiledMMA") || trimmed.contains("CUTE_") {
            tensor_ops += 1;
        }
    ...
    let loop_factor = if explicit_loops > 0 { 8u64.max(explicit_loops * 16) } else { 1u64 };

    let total = (global_loads + global_stores + shared_loads + shared_stores + arith_fma + arith_add + arith_mul + arith_div + arith_other + sync_instructions + branch_instructions + tensor_ops) * loop_factor * per_thread_scale;
...
pub fn analyze_memory(source: &str, config: &LaunchConfig, arch: &ArchSpec) -> MemoryAnalysis {
    let code = source;
    let var_count = code.split(|c: char| c.is_whitespace() || c == ',' || c == ';' || c == '(' || c == ')' || c == '{' || c == '}')
        .filter(|w| !w.is_empty() && w.chars().next().map_or(false, |c| c.is_ascii_lowercase()))
    ...
    let thread_stride = if code.contains("blockDim.x") || code.contains("blockIdx.x") {
        ...
        if has_stride { 4 } else { 1 }
    } else { 1 };

    let coalescing_efficiency = if thread_stride == 1 {
        1.0
    } else {
        (1.0 / thread_stride as f64).min(1.0).max(0.125)
    };

    let warp_size = arch.warp_size as u64;
    let _bytes_per_sector = 32u64;
    let cache_line = 128u64;
    let ideal_trans = (warp_size * 4 + cache_line - 1) / cache_line;
    let stride = thread_stride as u64;
    let actual_trans = if stride == 1 {
        ideal_trans
    } else {
        (warp_size * 4 * stride + cache_line - 1) / cache_line
    };
    let sector_util = if actual_trans > 0 { ideal_trans as f64 / actual_trans as f64 } else { 1.0 };

    // Shared memory bank conflict analysis
    let has_shared = code.contains("__shared__") || code.contains("shared_mem") || code.contains("s_data[") || code.contains("shared[");
    let shared_bank_conflicts = if has_shared {
        let bank_conflict_patterns = [
            "threadIdx.x",
            "threadIdx.y",
            " & 0x1f",
            " % 32",
        ...
        for pat in &bank_conflict_patterns {
            if code.contains(pat) { conflicts += 1; }
        }
        if code.contains("s_data[threadIdx.x") { conflicts += 2; }
        if code.contains("s_data[blockIdx") { conflicts = 0; }
        conflicts
    } else { 0 };

    let shared_transactions = if has_shared {
        if shared_bank_conflicts > 0 { 2 * arch.warp_size as u64 } else { arch.warp_size as u64 / 4 }
    } else { 0 };
...
fn is_keyword(w: &str) -> bool {
    matches!(w, "int" | "float" | "double" | "char" | "void" | "long" | "short" | "unsigned" | "const" | "static" | "__global__" | "__device__" | "__shared__" | "__managed__" | "if" | "else" | "for" | "while" | "do" | "switch" | "case" | "break" | "continue" | "return" | "struct" | "class" | "template" | "typedef" | "using" | "namespace" | "true" | "false" | "nullptr" | "NULL" | "new" | "delete" | "sizeof" | "auto" | "volatile" | "inline" | "extern")
}
...
pub fn analyze_divergence(source: &str, _config: &LaunchConfig, profile: &InstructionProfile) -> DivergenceAnalysis {
    let code = source;
    let uses_thread_id = code.contains("threadIdx.x") || code.contains("threadIdx.y") || code.contains("threadIdx.z");
    let uses_block_id = code.contains("blockIdx.x") || code.contains("blockIdx.y") || code.contains("blockIdx.z");
    ...
    for line in code.lines() {
        let t = line.trim();
        if t.contains("if ") && (t.contains("threadIdx") || t.contains("blockIdx") || t.contains(" % ") || t.contains(" < ")) {
            divergent_branches += 1;
        }
        if t.contains("if ") || t.contains("else ") { total_branches += 1; }
    }
    ...
    } else if var_based { 0.3 } else { 0.0 };

    let reconvergence_cost = (div_pct * 16.0 * profile.branch_instructions as f64 / 1000.0) as u64;

    DivergenceAnalysis { divergence_pct: div_pct * 100.0, divergent_branches, reconvergence_cost_cycles: reconvergence_cost }
}
...
pub fn calculate_occupancy(config: &LaunchConfig, arch: &ArchSpec, shared_mem_bytes: u32, registers: u32) -> OccupancyResult {
    let threads = config.block_x * config.block_y * config.block_z;
    let warps = (threads + 31) / 32;

    let by_threads = arch.max_threads_per_sm / threads;
    let by_blocks = arch.max_blocks_per_sm;
    let by_warps = arch.warps_per_sm / warps;
    let by_shared = if shared_mem_bytes > 0 { arch.shared_mem_per_sm / shared_mem_bytes } else { by_threads.max(by_blocks) };
    let by_registers = if registers > 0 {
        let regs_per_block = registers as u64 * threads as u64;
        if regs_per_block > 0 { (arch.register_file_size as u64 / regs_per_block) as u32 } else { by_threads }
    } else { by_threads };

    let mut blocks = by_blocks.min(by_threads).min(by_warps);
    let mut limiter = "max_blocks_per_sm";

    if by_threads < blocks { blocks = by_threads; limiter = "max_threads_per_sm"; }
    if by_warps < blocks { blocks = by_warps; limiter = "max_warps_per_sm"; }
    if by_shared < blocks { blocks = by_shared; limiter = "shared_memory"; }
    if by_registers < blocks { blocks = by_registers; limiter = "registers"; }
    ...
    OccupancyResult { threads_per_block: threads, blocks_per_sm: blocks, warps_per_sm: active_warps, max_warps_per_sm: arch.warps_per_sm, occupancy_pct: occ * 100.0, limiting_factor: limiter }
}
...
pub fn build_latency_model(arch: &ArchSpec) -> LatencyModel {
    ...
    LatencyModel {
        ...
        sync_cycles: if arch.family == "Volta" || arch.family == "Hopper" { 8 } else { 16 },
        branch_mispredict_cycles: 8,
        tensor_core_cycles: if arch.family == "Hopper" || arch.family == "Blackwell" { 2 } else { 4 },
...
pub fn emulate(source: &str, config: &LaunchConfig, arch: &GpuArch) -> EmulationResult {
    ...
    let occupancy = calculate_occupancy(config, specs, config.shared_mem_bytes, config.registers_per_thread);

    let total_blocks = config.grid_x as u64 * config.grid_y as u64 * config.grid_z as u64;
    let total_threads = total_blocks * config.block_x as u64 * config.block_y as u64 * config.block_z as u64;
    let total_warps = total_blocks * ((config.block_x * config.block_y * config.block_z + 31) / 32) as u64;

    // Cycle accounting
    let compute_ops = profile.arith_fma + profile.arith_add + profile.arith_mul + profile.arith_div + profile.arith_other;
    let mem_ops = profile.global_loads + profile.global_stores + profile.shared_loads + profile.shared_stores;
    ...
    let warps_per_block = ((config.block_x * config.block_y * config.block_z + 31) / 32) as u64;
    ...
    let branch_cycles = (branch_ops * divergence.divergent_branches / total_warps.max(1)).max(1) * latency.branch_mispredict_cycles;
    ...
    let compute_total = arith_cycles + tensor_cycles + sync_cycles + branch_cycles + reconvergence_cycles;
    let memory_total = mem_cycles;
    let overlap_factor = (active_warps as f64 / 8.0).min(1.0).max(0.3);
    ...
    let exec_time_us = if specs.core_clock_mhz > 0 { total_cycles as f64 / specs.core_clock_mhz as f64 } else { 0.0 };

    // Bottleneck analysis
    let bottleneck = if compute_total > memory_total * 2 { "Compute-bound" }
    else if memory_total > compute_total * 2 { "Memory-bound" }
    else { "Balanced" };
...
pub fn emulate_multi(source: &str, config: &LaunchConfig, arches: &[GpuArch]) -> Vec<EmulationResult> {
    ...
    if results.len() >= 2 {
        ...
        for r in &results[1..] {
            if base.total_cycles > 0 {
                ...
                let _ = writeln!(out, "  {:<24} {:>12.2}x vs {}", "",
...
pub fn execution_report(result: &EmulationResult) -> String {
    ...
    let _ = writeln!(out, "  GPU: {} ({})", result.arch_name, result.arch_spec.compute_cap);
    let _ = writeln!(out, "  Grid: {} x {} x {} | Block: {} x {} x {}",
        result.launch.grid_x, result.launch.grid_y, result.launch.grid_z,
        result.launch.block_x, result.launch.block_y, result.launch.block_z);
    let _ = writeln!(out, "  Total: {} warps, {} threads",
        result.total_warps, result.total_threads);
    let _ = writeln!(out);

    let _ = writeln!(out, "  --- Execution ---");
    let _ = writeln!(out, "  {:24}: {:>12} cycles", "Total Cycles", result.total_cycles);
    let _ = writeln!(out, "  {:24}: {:>12}", "Total Instructions", result.total_instructions);
    let _ = writeln!(out, "  {:24}: {:>12.2}", "IPC", result.ipc);
    let _ = writeln!(out, "  {:24}: {:>12.1} us", "Estimated Time", result.execution_time_us);
    ...
    let _ = writeln!(out, "  {:24}: {}", "Limiting Factor", result.occupancy.limiting_factor);
    let _ = writeln!(out);

    let _ = writeln!(out, "  --- Memory ---");
    let _ = writeln!(out, "  {:24}: {:>9.0}%", "Coalescing Eff.", result.memory.coalescing_efficiency * 100.0);
    let _ = writeln!(out, "  {:24}: {:>9.1}%", "Sector Util.", result.memory.sector_utilization * 100.0);
    let _ = writeln!(out, "  {:24}: {}", "Bank Conflicts",
        if result.memory.shared_bank_conflicts > 0 { format!("{} detected", result.memory.shared_bank_conflicts) } else { "None".into() });
    let _ = writeln!(out, "  {:24}: {} / thread", "Register Pressure", result.memory.register_pressure);
    let _ = writeln!(out, "  {:24}: {} (max {})", "Register Spills", result.memory.register_spills, result.memory.max_registers_per_thread);
    let _ = writeln!(out);

    let _ = writeln!(out, "  --- Divergence ---");
    let _ = writeln!(out, "  {:24}: {:>9.1}%", "Divergent Branches", result.divergence.divergence_pct);
    let _ = writeln!(out, "  {:24}: {} cycles", "Reconvergence Cost", result.divergence.reconvergence_cost_cycles);
    let _ = writeln!(out);

    let _ = writeln!(out, "  --- Instruction Mix ---");
    let _ = writeln!(out, "  {:24}: {:>12}", "Arithmetic", result.instruction_profile.arith_fma + result.instruction_profile.arith_add + result.instruction_profile.arith_mul + result.instruction_profile.arith_div + result.instruction_profile.arith_other);
    let _ = writeln!(out, "  {:24}: {:>12}", "Memory (global)", result.instruction_profile.global_loads + result.instruction_profile.global_stores);
    let _ = writeln!(out, "  {:24}: {:>12}", "Memory (shared)", result.instruction_profile.shared_loads + result.instruction_profile.shared_stores);
    let _ = writeln!(out, "  {:24}: {:>12}", "Tensor Core", result.instruction_profile.tensor_ops);
    let _ = writeln!(out, "  {:24}: {:>12}", "Sync", result.instruction_profile.sync_instructions);
    let _ = writeln!(out, "  {:24}: {:>12}", "Branches", result.instruction_profile.branch_instructions);
    let _ = writeln!(out);

    let _ = writeln!(out, "  --- Roofline ---");
    let _ = writeln!(out, "  {:24}: {:>12.3} ops/byte", "Arith. Intensity", result.roofline_arith_intensity);
    if result.roofline_arith_intensity > 0.0 {
        let peak_compute = result.arch_spec.sm_count as f64 * result.arch_spec.core_clock_mhz as f64 * 64.0 / 1000.0;
        let peak_mem = result.arch_spec.mem_bandwidth_gbps;
        let ridge_point = peak_compute / peak_mem;
        let _ = writeln!(out, "  {:24}: {:>12.1} ops/byte", "Ridge Point", ridge_point);
        let _ = writeln!(out, "  {:24}: {}",
            "Region",
            if result.roofline_arith_intensity > ridge_point { "Compute-bound" } else { "Memory-bound" });
    }
...
pub fn language_config_hint(lang: GpuLanguage, arch: &ArchSpec) -> String {
    match lang {
        GpuLanguage::Cuda => format!("nvcc -arch=sm_{} kernel.cu", arch.compute_cap.replace('.', "")),
        GpuLanguage::Triton => format!("@triton.autotune with target=sm_{}", arch.compute_cap.replace('.', "")),
        GpuLanguage::Mojo => format!("mojo build --target cuda --arch sm_{}", arch.compute_cap.replace('.', "")),
        GpuLanguage::Numba => format!("numba.cuda.select_device(0) # simulates {}", arch.name),
        GpuLanguage::PyTorch => format!("torch.compile(model, mode='max-autotune', backend='inductor') # target {}", arch.name),
        GpuLanguage::Cute => format!("nvcc -arch=sm_{} -DCUTE_ARCH_SM{} kernel.cu", arch.compute_cap.replace('.', ""), arch.compute_cap.replace('.', "")),
        GpuLanguage::CudaTile => format!("nvcc -arch=sm_{} --use_fast_math kernel.cu", arch.compute_cap.replace('.', "")),
        GpuLanguage::TileLang => format!("tilelang.compile(kernel, target='cuda', arch='sm_{}')", arch.compute_cap.replace('.', "")),
        GpuLanguage::Unknown => format!("Target GPU: {} (sm_{})", arch.name, arch.compute_cap.replace('.', "")),
    }
}
...
mod tests {
    ...
    fn test_occupancy_calculation() {
        let config = LaunchConfig { block_x: 256, block_y: 1, block_z: 1, ..Default::default() };
    ...
    let threads_per_block = config.block_x * config.block_y * config.block_z;
        let expected_warps = (threads_per_block + 31) / 32;
    ...
    fn test_coalescing_efficiency() {
        ...
        assert!(mem.coalescing_efficiency > 0.9, "contiguous access should coalesce");
    }
    ...
    fn test_shared_bank_conflicts_detected() {
        ...
        let arch = arch_by_enum(GpuArch::Ampere86);
        let mem = analyze_memory(source, &config, arch);
        assert!(mem.shared_bank_conflicts > 0, "strided access should cause bank conflicts");
    }

    #[test]
    fn test_register_spills_high_pressure() {
        let source = "int a0,a1,a2,a3,a4,a5,a6,a7,a8,a9; int b0,b1,b2,b3,b4,b5,b6,b7,b8,b9;";
        let config = LaunchConfig { block_x: 128, registers_per_thread: 128, ..Default::default() };
    ...
    fn test_multi_arch_comparison() {
        ...
        let config = LaunchConfig { block_x: 256, grid_x: 100, ..Default::default() };
    ...
    fn test_divergence_analysis() {
        ...
        let config = LaunchConfig { block_x: 32, ..Default::default() };
        let profile = extract_instruction_profile(source, &config);
    ...
    fn test_extract_instructions() {
        let source = "int i = threadIdx.x;\n__syncthreads();\na[i] = b[i] + c[i];\n__syncthreads();";
        let config = LaunchConfig { block_x: 256, grid_x: 10, ..Default::default() };
        let profile = extract_instruction_profile(source, &config);
    ...
    fn test_tensor_core_detection() {
        ...
        let config = LaunchConfig { block_x: 32, ..Default::default() };
        let profile = extract_instruction_profile(source, &config);
        assert!(profile.tensor_ops > 0, "wmma should be counted as tensor op");
    }
