...
//! string/text manipulation. Harness-bound extraction (Ai chat's
//! `AiConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `AiMessage` assembly) stays in the harness crate.
