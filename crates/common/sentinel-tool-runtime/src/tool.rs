...
/// `filename`, `path`, `metadata`) that the Ai SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Ai SLOP converter to
    ...
    /// - `path`: file path on the Ai Computer filesystem
