...
use sentinel_tool_protocol::{SessionId, session_event::SessionEvent};
...
mod tests {
    use super::*;
    use sentinel_tool_protocol::session_event::{SessionEvent, SessionPhase, ToolCallOutcome};
