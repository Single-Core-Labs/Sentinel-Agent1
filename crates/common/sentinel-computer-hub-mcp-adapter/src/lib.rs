//! Unified MCP adapter for the AI Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](sentinel_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](sentinel_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
