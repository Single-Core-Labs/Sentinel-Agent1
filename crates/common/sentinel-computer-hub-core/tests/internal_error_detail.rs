...
use sentinel_computer_hub_core::{error_from_envelope, tool_error_from_wire};
use sentinel_tool_protocol::{JsonRpcError, RequestId, ToolErrorWire};
use sentinel_tool_runtime::ToolErrorKind;
use serde_json::json;
