...
fn map_block(block: sentinel_tool_protocol::McpBlock) -> ContentBlock {
    use sentinel_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: sentinel_tool_protocol::JsonRpcError) -> ToolError {
