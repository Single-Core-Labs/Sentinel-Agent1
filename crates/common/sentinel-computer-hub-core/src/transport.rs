...
//!
//! [`TransportKind`] is re-exported from [`sentinel_tool_protocol`] so the wire
...
use sentinel_tool_protocol::{SessionId, ToolId, UserId};
use sentinel_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use sentinel_tool_protocol::TransportKind;
