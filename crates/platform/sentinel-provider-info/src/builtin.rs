...
pub fn local_model_providers() -> Vec<(ProviderInfo, LocalModelConfig)> {
    vec![
        (
            ...
            LocalModelConfig {
                prefix: "ollama/".into(),
                base_url_env: "OLLAMA_BASE_URL".into(),
                api_key_env: "OLLAMA_API_KEY".into(),
                base_url_default: "http://localhost:11434".into(),
            },
        ),
        (
            ProviderInfo {
            ...
            LocalModelConfig {
                prefix: "vllm/".into(),
                base_url_env: "VLLM_BASE_URL".into(),
                api_key_env: "VLLM_API_KEY".into(),
                base_url_default: "http://localhost:8000".into(),
            },
        ),
        (
            ProviderInfo {
            ...
            LocalModelConfig {
                ...
                base_url_env: "LMSTUDIO_BASE_URL".into(),
                api_key_env: "LMSTUDIO_API_KEY".into(),
                base_url_default: "http://127.0.0.1:1234".into(),
            },
        ),
        (
            ProviderInfo {
            ...
            LocalModelConfig {
                ...
                base_url_env: "LLAMACPP_BASE_URL".into(),
                api_key_env: "LLAMACPP_API_KEY".into(),
                base_url_default: "http://localhost:8080".into(),
            },
        ),
    ]
}
...
pub fn is_local_model_id(model_id: &str) -> bool {
    ...
    local_model_providers()
        .iter()
        .any(|(_, config)| model_id.starts_with(&config.prefix))
}
