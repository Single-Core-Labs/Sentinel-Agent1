...
HF_BILLING_USAGE_V2_URL = "https://platformops.co/api/settings/billing/usage-v2"
HF_BILLING_USAGE_BY_INFERENCE_SESSION_URL = (
    "https://platformops.co/api/settings/billing/usage-by-inference-session"
)
HF_BILLING_URL = "https://platformops.co/settings/billing"
HF_INFERENCE_PROVIDERS_PRICING_URL = (
    "https://platformops.co/docs/inference-providers/en/pricing"
)
HF_JOBS_PRICING_URL = "https://platformops.co/docs/hub/jobs-pricing"
