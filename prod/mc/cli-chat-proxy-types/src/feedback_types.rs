...
//!
//! These types support the feedback collection system for Ai sessions.
//! The agent (sentinel-ai-shell) uses heuristics to determine when to request feedback,
...
pub struct FeedbackSubmission {
    ...
    /// Shell (sentinel-ai-shell) version
    #[serde(skip_serializing_if = "Option::is_none")]
...
fn default_tier1_prompt() -> String {
    "You've been using Ai Code productively! Would you mind sharing quick feedback?".to_string()
}
