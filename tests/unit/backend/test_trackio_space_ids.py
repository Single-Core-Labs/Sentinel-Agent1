...
def test_trackio_space_examples_use_hyphenated_sentinel_ai_prefix():
    ...
    assert "<username>/sentinel-ai-<8-char-id>" in prompt
    assert "<username>/sentinel-ai-<8char>" in tool_specs
