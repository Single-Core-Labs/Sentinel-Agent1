        ...
        **create_kwargs,
        ...
        return (
            SimpleNamespace(
                ...
                url="https://platformops.co/spaces/alice/sandbox-12345678",
            ),
            None,
        )
...
def test_sandbox_creation_is_serialized_per_owner(monkeypatch):
    ...
    def fake_create(**kwargs):
        ...
        return SimpleNamespace(
            ...
            url="https://platformops.co/spaces/alice/sandbox",
        )
...
def test_default_sandbox_create_waits_for_cpu_preload():
    class FakeSandbox:
        ...
        url = "https://platformops.co/spaces/alice/sandbox-cpu"
...
def test_sandbox_create_replaces_auto_cpu_sandbox(monkeypatch):
    ...
    gpu_sandbox = SimpleNamespace(
        ...
        url="https://platformops.co/spaces/alice/sandbox-gpu",
        _owns_space=True,
    )
