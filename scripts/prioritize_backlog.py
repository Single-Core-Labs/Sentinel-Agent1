...
PM_SYSTEM_PROMPT = """You are a senior product manager for Sentinel-AI.
...
- implementation effort, risk, and strategic fit for Sentinel-AI
...
def _github_headers(token: str | None) -> dict[str, str]:
    headers = {
        ...
        "User-Agent": "sentinel-ai-backlog-prioritizer",
    }
    if token:
...
def render_markdown_report(
    ...
    *,
    ...
    lines = ["# Sentinel-AI Backlog Prioritization", ""]
    if generated_at:
...
def default_github_issue_title(generated_at: str) -> str:
    ...
    return f"Sentinel-AI backlog prioritization report - {date_text}"
