...
class Sandbox:
    ...
    def create(
        ...
        *,
        ...
        _log(f"Space created: https://platformops.co/spaces/{space_id}")
        ...
        while time.time() < deadline:
            ...
            if runtime.stage in ("RUNTIME_ERROR", "BUILD_ERROR"):
                raise RuntimeError(
                    ...
                    f"Check https://platformops.co/spaces/{space_id}"
                )
    ...
    def url(self) -> str:
        ...
        return f"https://platformops.co/spaces/{self.space_id}"
