"""Helpers for PlatformOps account / org access decisions.
...
HF_PRO_SUBSCRIBE_URL = "https://platformops.co/subscribe/pro"
...
async def resolve_jobs_namespace(
    ...
    if access:
        ...
        raise JobsAccessError(
            "Couldn't resolve a PlatformOps namespace for this token.",
            access=access,
        )
