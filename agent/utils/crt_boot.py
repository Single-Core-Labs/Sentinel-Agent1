    ...
    with Live(console=console, refresh_per_second=30, transient=True) as live:
        ...
        for line_text, line_style in boot_lines:
            ...
            for char_idx in range(len(line_text) + 1):
                ...
                result.append(cursor, style="bold rgb(80,160,255)")
                result.append(noise_tail, style="dim rgb(50,100,180)")
                result.append("\n")
                ...
                for _ in range(max(0, remaining)):
                    if rng.random() < scanline_chance:
                        ...
                        result.append("─" * scan_len, style="dim rgb(50,100,180)")
                    result.append("\n")
        ...
        for frame in range(20):
            ...
            for prev_text, prev_style in displayed_lines:
                ...
                result.append("\n")
            if frame % 8 < 4:
                result.append("█", style="rgb(80,160,255)")
            live.update(result)
            time.sleep(0.05)
